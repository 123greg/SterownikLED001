...
void loadSettings(const char* filename, Settings* settings) {
    ...
    // Główne parametry
    settings->main_effect             = doc["main_effect"]             | 1;
    settings->effect_speed            = doc["effect_speed"]            | 10;
    settings->fade_delay              = doc["fade_delay"]              | 100;
    settings->light_threshold         = doc["light_threshold"]         | 10;
    settings->floor_set               = doc["floor_set"]    	       | 0;

    // Kolory (grupa 1)
    settings->color_H_1               = doc["color_H_1"]               | 10;
    settings->color_S_1               = doc["color_S_1"]               | 100;
    settings->color_V_1               = doc["color_V_1"]               | 100;

    // Kolory (grupa 2)
    settings->color_H_2               = doc["color_H_2"]               | 20;
    settings->color_S_2               = doc["color_S_2"]               | 100;
    settings->color_V_2               = doc["color_V_2"]               | 100;

    // Kolory (grupa 3)
    settings->color_H_3               = doc["color_H_3"]               | 30;
    ...
    settings->v_direction             = doc["v_direction"]             | 0;
    settings->h_direction             = doc["h_direction"]             | 1;
...
void saveSettings(const char* filename, const Settings* settings) {
    ...
    doc["floor_set"]   	           = settings->floor_set;
    ...
    doc["v_direction"]             = settings->v_direction;
    doc["h_direction"]             = settings->h_direction;
